...
![TCP连接的生命周期](/static/image/markdown/browser/network-protocol/tcp-lifecycle.png)
...
![TCP和HTTP的关系](/static/image/markdown/browser/network-protocol/tcp-http.png)
...
![永久重定向](/static/image/markdown/browser/network-protocol/permanent-redirect.png)
...
![响应内容的格式](/static/image/markdown/browser/network-protocol/response-content-format.png)
...
![页面缓存](/static/image/markdown/browser/network-protocol/page-cache.png)
