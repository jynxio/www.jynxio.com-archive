...
因为大部分的 JavaScript 引擎都混合使用了编译器和解释器，比如 V8、JavaScriptCore、SpiderMonkey，所以我们可以认为现代的 JavaScript 是一门既有编译执行，又有解释执行的语言，你可以通过本博客的另一篇文章《V8 JIT》来了解更多细节。

V8 引擎在执行 JavaScript 代码之前，需要对其进行编译，
