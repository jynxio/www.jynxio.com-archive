...
const DOWN_SVG = "<svg xmlns=\"http://www.w3.org/2000/svg\" width=\"24\" height=\"24\" viewBox=\"0 0 24 24\" fill=\"none\" stroke=\"currentColor\" stroke-width=\"2\" stroke-linecap=\"round\" stroke-linejoin=\"round\" class=\"lucide lucide-chevron-down\"><polyline points=\"6 9 12 15 18 9\"></polyline></svg>";
...
function parseMarkdown ( markdown: string ) {
	...
	function parseCode ( code: string, language: string | undefined, escaped: boolean ) {
		...
		if ( language === "" || language === void 0 ) {
			...
			return createCustomPre( codeContent, DOWN_SVG );
		...
		return createCustomPre( hljs.highlight( code, { language } ).value, DOWN_SVG );
	...
	function createCustomPre ( codeContent: string, svg: string ) {
